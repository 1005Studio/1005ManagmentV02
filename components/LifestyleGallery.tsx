  ...
  return (
    <>
        ...
        <div className="bg-[#F8F9FA] dark:bg-[#090909] w-full h-full md:rounded-3xl md:max-w-6xl overflow-hidden flex flex-col shadow-2xl border border-gray-100 dark:border-gray-800">
          ...
          <div className="shrink-0 px-6 py-5 bg-white dark:bg-[#121212] border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
            <div>
              <h2 className="font-extrabold text-2xl text-gray-900 dark:text-white font-brand flex items-center gap-3">
                <span className="bg-black dark:bg-white text-white dark:text-black p-2 rounded-xl"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg></span>
                Lifestyle
              </h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1 ml-1">Instagram & Sosyal Medya Referansları.</p>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-gray-50/50 dark:bg-[#090909]">
            {sortedItems.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center py-20 opacity-60">
                ...
                <p className="font-bold text-xl text-gray-900 dark:text-white">Referans Yok</p>
                <p className="text-base mt-2 text-gray-500 dark:text-gray-400 max-w-md">Beğendiğin çekim örneklerini buraya yükle.</p>
              </div>
            ) : (
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-6 pb-24 md:pb-0">
                {sortedItems.map((item, index) => (
                  <div 
                    ...
                    className="group relative aspect-[3/4] bg-white dark:bg-[#1E1E1E] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 cursor-zoom-in overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                  >
                    <img src={item.imageUrl} alt="Ref" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all flex flex-col justify-end p-3 md:p-4">
                      <div className="flex items-center justify-end gap-2">
                          ...
                          className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center bg-white text-red-600 rounded-xl hover:bg-red-50 pointer-events-auto z-10 shadow-lg transition-transform active:scale-95"
                          title="Sil"
                          >
          ...
          <div className="shrink-0 p-4 md:p-6 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-[#121212] flex justify-between items-center gap-6 relative z-20 pb-safe">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400 font-medium">
              <strong className="text-gray-900 dark:text-white">{sortedItems.length}</strong> referans
            </div>
            <button 
            ...
            >
              {isUploading ? 'Yükleniyor...' : (
                <>
                  ...
                  <span className="hidden md:inline">Yeni İlham Yükle</span>
      ...
      <ImageViewer 
        ...
        images={sortedItems.map(i => ({ id: i.id, url: i.imageUrl }))}
